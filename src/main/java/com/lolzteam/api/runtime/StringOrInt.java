...
/**
 * Represents a value that can be either a String or an integer (long).
 * Used for OpenAPI schemas with {@code type: ['string', 'integer']}.
 */
	...
	final class Deserializer extends JsonDeserializer<StringOrInt> {
		...
		public StringOrInt deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
			return switch (p.currentToken()) {
				...
				default -> throw ctxt.weirdStringException(
