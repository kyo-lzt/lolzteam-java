...
public final class LolzteamHttpClient implements Closeable {
	...
	private void writeMultipartField(ByteArrayOutputStream baos, String boundary, String name, String value)
		throws IOException {
		var header = "--" + boundary + "\r\n"
	...
	private void writeMultipartFile(ByteArrayOutputStream baos, String boundary, String name, byte[] data)
		throws IOException {
		var header = "--" + boundary + "\r\n"
	...
	private static URI parseProxyUri(String url) {
		...
		if (scheme == null || (!scheme.equalsIgnoreCase("http")
			...
			throw new ConfigException("unsupported proxy scheme: " + (scheme != null ? scheme : "<none>")
				+ ". Java's HttpClient only supports HTTP/HTTPS proxies");
		}
